...
class Add_Group_Memeber_2 extends StatefulWidget {

  var roomIds;


  Add_Group_Memeber_2({this.roomIds});

  @override
  _Add_Group_Memeber_2State createState() => _Add_Group_Memeber_2State();
}

class _Add_Group_Memeber_2State extends State<Add_Group_Memeber_2> {
                              ...
                              Container(
                                ...
                                child: Card(
                                  ...
                                  child: TextField(
                                    onChanged: (value) {
                                      setState(() {
                                        searchString5 = value.replaceAll(" ", "").toLowerCase();
                                      });
                                    },
  ...
  Widget makeFriend(BuildContext context, DocumentSnapshot documnents) {
    ...
    if (toName.contains(searchString5)) {
